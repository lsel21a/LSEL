...
class Drone(object):
    def __init__(self, vehicle, server_enabled=True):
        ...
        self.current_coords = []
        ##self.webserver_enabled = server_disabled ##Aparte
    ...
    def launch(self):
        ...
        self.home_coords = [self.vehicle.location.global_frame.lat,
                            self.vehicle.location.global_frame.lon] #Editar aqui para poder leerlo desde mqtt
        
       # self.home_coords = [42.4658,
       #                    -2.44999]
    ...
    def takeoff(self):
        ...
        self.vehicle.simple_takeoff(10.0)
