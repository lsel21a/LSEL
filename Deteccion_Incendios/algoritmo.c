...
int algoritmo_incendio(int *Temperatura, int *Humedad, int *Gases)

{
  ...
  for (i = 0; i < Datos_N; i++)
  {
    ...
    {
      posible_incendio1 = posible_incendio1 + 1;
    }
    else if (Temperatura[i] > Tmax && Gases[i] > Gmax)
    {
      posible_incendio2 = posible_incendio2 + 1;
    }
    else if (Humedad[i] < Hmin && Gases[i] > Gmax)
    {
      posible_incendio3 = posible_incendio3 + 1;
    }
    else 
    {
      break;
